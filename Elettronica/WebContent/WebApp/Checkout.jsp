										...
										<div class="woocommerce-billing-fields">
											...
											<p id="billing_company_field" class="form-row form-row-wide">
												<label class="" for="billing_company">Company Name</label> <input
													type="text" value="" placeholder="" id="billing_company"
											...
											<p id="billing_state_field"
												...
												<label class="" for="billing_state">County</label> <input
													type="text" id="billing_state" name="billing_state"
											...
											<div class="create-account">
												...
												<p id="account_password_field"
													...
													</label> <input type="password" value="" placeholder="Password"
										...
										<tbody>
											<tr class="cart_item">
												<td class="product-name">Ship Your Idea <strong
													class="product-quantity">x 1</strong>
												</td>
												<td class="product-total"><span class="amount">&#163 15.00</span>
												</td>
											</tr>
										</tbody>
										<tfoot>
											...
											<tr class="cart-subtotal">
												<th>Cart Subtotal</th>
												<td><span class="amount">&#163 15.00</span></td>
											</tr>
											...
											<tr class="order-total">
												<th>Order Total</th>
												<td><strong><span class="amount">&#163 15.00</span></strong>
												</td>
											</tr>
